...
@EnableJpaRepositories(basePackages = "com.wugd.springcloud.dao" )//启用JPA资源库并指定资源库接口位置
@EntityScan(basePackages = "com.wugd.springcloud.entity")//指定实体的位置
public class JPAPersistenceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource druidDataSource){
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.wugd.springcloud.entity");
